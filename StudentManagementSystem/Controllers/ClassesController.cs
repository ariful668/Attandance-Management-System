...
namespace StudentManagementSystem.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(NewAttendanceContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("ClassId,ClassName")] Classes classes)
        {
        ...
        private bool ClassesExists(long id)
        {
