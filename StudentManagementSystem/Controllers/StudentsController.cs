...
namespace StudentManagementSystem.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(NewAttendanceContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("StudentId,StudentName,StudentGender,StudentAddress,FatherName,FatherPhone,MotherName,MotherPhone,Email,DateOfBirth")] Students students)
        {
